...
/// <summary>
/// AudioClipMaker
/// <see>https://github.com/Suzeep/audioclip_maker/blob/master/Assets/Scripts/AudioClipMaker.cs</see>
/// </summary>
public class AudioClipMaker
{
    // constant
    public readonly static float RANGE_VALUE_BIT_8 = 1.0f / Mathf.Pow(2, 7);   // 1 / 128
    public readonly static float RANGE_VALUE_BIT_16 = 1.0f / Mathf.Pow(2, 15); // 1 / 32768
    ...
    //---------------------------------------------------------------------------
    public static float ConvertByteToFloatData(byte[] byte_data, int idx, int bit_per_sample)
    {
